...
class FinancialSnapshot extends StatefulWidget {
  const FinancialSnapshot({super.key});

  @override
  State<FinancialSnapshot> createState() => _FinancialSnapshotState();
}

class _FinancialSnapshotState extends State<FinancialSnapshot> {
  final spots = const [
    FlSpot(1.68, 21.04),
    FlSpot(2.84, 26.23),
    FlSpot(5.19, 19.82),
